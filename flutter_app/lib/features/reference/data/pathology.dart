...
final List<Pathology> initialPathologyData = [
  Pathology(
    ...
    clinicalSigns: const ['Polyuria (PU)', 'Polydipsia (PD)', 'Polyphagia', 'Weight loss'],
    diagnosticSteps: const ['Blood Glucose', 'Urinalysis (Glucosuria/Ketonuria)', 'Fructosamine'],
  ...
  Pathology(
    ...
    clinicalSigns: const ['PU/PD', 'Vomiting', 'Anorexia', 'Lethargy', 'Weight loss'],
    diagnosticSteps: const ['Creatinine & SDMA', 'Urine Specific Gravity (USG < 1.035 in dogs, < 1.040 in cats)', 'Blood Pressure'],
  ...
  Pathology(
    ...
    clinicalSigns: const ['Coughing (dogs)', 'Increased Sleeping Respiratory Rate (SRR > 30)', 'Exercise intolerance', 'Dyspnea'],
    diagnosticSteps: const ['Thoracic Radiographs', 'Echocardiography', 'NT-proBNP'],
